...
<div style="margin-left: 2%; margin-right: 2%;">
    <div class="row" style="height: 80vh; overflow: scroll;">
        <strong>
            <span class="page-title">Add Programme</span>
        </strong>
        <hr>
        <form class="form-horizontal form-material" method="POST"
            action="<?php echo base_url();?>admin/programme/create" enctype="multipart/form-data">
            ...
            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <input type="text" class="form-control p-0 border-0" name="name" required="" value="" autofocus
                    placeholder="Programme name (English)" label="Name">
            </div>
            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <input type="text" class="form-control p-0 border-0" name="nameFre" required="" value="" autofocus
                    placeholder="Programme name (French)" label="French Name">
            </div>
            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <input type="text" class="form-control p-0 border-0" name="nameKin" required="" value="" autofocus
                    placeholder="Programme name (Kinyarwanda)" label="Kinyarwanda Name">
            </div>
            </div>
            <br>
            ...
            <div class="row">
                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <h3 class="box-title aog-title" style="color: black;">English Short Description</h3>
                    <textarea name="shortDesc"></textarea>
                </div>
                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <h3 class="box-title aog-title" style="color: black;">English Full Description</h3>
            ...
            <div class="row">
                ...
                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <h3 class="box-title aog-title" style="color: black;">Kinyarwanda Full Description</h3>
                    <textarea name="descriptionKin"></textarea>
                </div>
            </div><br>

            <div class="white-box">
            <h3 class="box-title aog-title" style="color: black;">Add Image</h3>
            <input type="file" name="image" placeholder="image" placeholder="Image">
            </div>
            <br>
            <center><button class="btn btn-primary aog-btn">Add Programme</button></center>
        </form>
