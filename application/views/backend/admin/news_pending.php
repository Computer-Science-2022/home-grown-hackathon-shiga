...
<div class="tab-content">
		<div class="tab-pane box active" id="list">
          <div class="white-box">
            ...
            <th style="text-align: center;"><?php echo get_phrase('Edit');?></th>
              ...
              <?php 
              $i = 0;
		$posts	=	$this->db->get_where('news', array('status'=>'0'))->result_array();
		...
		?>
          ...
          <td style="text-align: center;" class="text-nowrap"><a href="<?php echo base_url();?>admin/news/approve/<?php echo $row['id'];?>" data-toggle="tooltip" data-original-title="Approve"><div class="badge badge-info">Approve</div></a> </td>

			    <td style="text-align: center;" class="text-nowrap"><a href="<?php echo base_url();?>admin/news/edit/<?php echo $row['id'];?>" data-toggle="tooltip" data-original-title="Edit"> <i class="fa fa-edit text-danger m-r-10"></i> </a> </td>
