...
<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
    ...
    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url();?>admin"><?php echo get_phrase('Dashboard'); ?></a></li>
	...
	<div class="col-md-12">
		<div class="panel panel-info" data-collapsed="0">
			...
			<div class="panel-body">
                 <?php echo form_open(base_url() . 'admin/gall_category/create/' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
