...
<?php 
$post = $this->db->get_where('articles', array('id' => $post_id))->result_array();
foreach ($post as $row):
?>
...
<div class="tab-content">
  <div class="white-box col-md-12">
        <div class="col-md-3">
          <img src="<?php echo $this->Crud_model->get_articles_image_url($row['image']);?>" width="100%">
        </div>
        <div class="col-md-9">
          <?php echo form_open(base_url() . 'admin/articles/update_profile/'.$row['image'], array('class' => 'form-horizontal form-groups-bordered validate ajax-submit', 'enctype' => 'multipart/form-data'));?>
    ...
    <div class="tab-pane box active" id="list">
      <form method="POST" action="<?php echo base_url().'Admin/articles/update/'.$post_id;?>">
          <div class="white-box">
