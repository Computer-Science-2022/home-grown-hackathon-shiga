          ...
          <div class="user-bg"> <img src="style/images/large/img.jpg" alt="user" style="100%">
            ...
            <div class="panel-body">
               <?php $edit_data = $this->db->get_where('editor' , array('editor_id' => $editor_id))->result_array();
                ...
                ?>
                    <?php echo form_open(base_url() . 'admin/editors/do_update/'.$row2['editor_id'], array('class' => 'form-horizontal form-groups-bordered validate ajax-submit', 'enctype' => 'multipart/form-data'));?>
            ...
            <div class="panel-body">
                   ...
                   $edit_datas = $this->db->get_where('editor' , array('editor_id' => $editor_id))->result_array();
                    foreach($edit_datas as $row3):
                        ?>
                         <?php echo form_open(base_url() . 'admin/editors/change_password/'.$row3['editor_id'], array('class' => 'form-horizontal form-groups-bordered validate ajax-submit', 'enctype' => 'multipart/form-data'));?>
