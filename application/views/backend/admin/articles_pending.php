...
<div class="tab-content">
		<div class="tab-pane box active" id="list">
          <div class="white-box">
            ...
            <th style="text-align: center;"><?php echo get_phrase('Edit');?></th>
              ...
              <?php 
              $i = 0;
		$posts	=	$this->db->get_where('articles', array('status'=>'0'))->result_array();
		...
		?>
          ...
          <td style="text-align: center;" class="text-nowrap"><a href="<?php echo base_url();?>admin/articles/approve/<?php echo $row['id'];?>" data-toggle="tooltip" data-original-title="Approve"><div class="badge badge-info">Approve</div></a> </td>

			    <td style="text-align: center;" class="text-nowrap"><a href="<?php echo base_url();?>admin/articles/edit/<?php echo $row['id'];?>" data-toggle="tooltip" data-original-title="Edit"> <i class="fa fa-edit text-danger m-r-10"></i> </a> </td>

           <td style="text-align: center;" class="text-nowrap"><a href="#" data-toggle="tooltip" onclick="confirm_modal('<?php echo base_url();?>admin/articles/delete/<?php echo $row['id'];?>' , '<?php echo base_url();?>admin/reload_admin_list');" data-original-title="Delete"> <i class="fas fa-trash text-danger m-r-10"></i> </a></td>
                </tr>
                <?php endforeach;?>
              </tbody>
            </table>
