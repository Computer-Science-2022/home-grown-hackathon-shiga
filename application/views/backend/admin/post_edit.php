...
<?php 
$post = $this->db->get_where('projects', array('id' => $post_id))->result_array();
foreach ($post as $row):
?>
...
<div class="tab-content">
  <div class="white-box col-md-12">
        <div class="col-md-3">
          <img src="<?php echo $this->Crud_model->get_post_image_url($row['image']);?>" width="100%">
        </div>
        <div class="col-md-9">
          <?php echo form_open(base_url() . 'admin/post/update_profile/'.$row['image'], array('class' => 'form-horizontal form-groups-bordered validate ajax-submit', 'enctype' => 'multipart/form-data'));?>
    ...
    <div class="tab-pane box active" id="list">
      <form method="POST" action="<?php echo base_url().'Admin/post/update/'.$post_id;?>">
          <div class="white-box">
          ...
          <div class="white-box">
              <h3 class="box-title" style="color: black;">French Post</h3>
              <!-- <textarea name="vision" class="textarea_editor form-control" id="text" required=""></textarea>  -->
