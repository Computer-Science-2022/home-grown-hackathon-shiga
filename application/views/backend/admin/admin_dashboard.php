...
<div class="row bg-title">
    ...
    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url(); ?>admin/admin_dashboard"><?php echo $system_title; ?></a></li>
...
<div class="col-md-6">
                <div class="alert alert-warning" style="background-color: #105f77;">
                    ...
                    <h4><font color="white">Projects</font></h4>
                    <p>Projects posted so far: </p>
                    <h3><font color="white"><span class="counter" style="color: white;"><?php echo $this->db->count_all('projects');?></span></font></h3>
                </div>
...
<div class="row">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12" >
                   ...
                   <div class="white-box" style="background-color: #9ab279">
                        ...
                        <ul class="list-inline two-part">
                            ...
                            <li class="text-right"><span class="counter"><font color="white"><?php echo $this->db->count_all('contactus');?></font></span></li>
                        </ul>
                    </div>
                </div>
</div>
                    ...
                    <div class="col-md-6">
                        <div class="white-box">
                            ...
                            <div class="table-responsive">
                                ...
                                <th style="text-align: center;"><div>Post</div></th>
    ...
    <td style="text-align: left;"><?php echo substr($row['project_eng'],0, 20);?>...</td>
              ...
              <table class="table">
                ...
                <tbody>
                 <?php $counter = 1;
                        $this->db->limit(7);
                        $this->db->order_by('id' , 'desc');
                        $inquiry =   $this->db->get('contactus')->result_array();
