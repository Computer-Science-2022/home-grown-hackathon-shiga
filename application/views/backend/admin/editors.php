<div class="row bg-title">
    ...
    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
        <ol class="breadcrumb">
            ...
            <li><a class="active">Editors</a></li>
        </ol>
    </div>
</div>
...
<div class="tab-content">
		<div class="tab-pane box active" id="list">
          <div class="white-box">
            ...
            <th style="text-align: center;"><?php echo get_phrase('Edit');?></th>
              ...
              <tbody>
              <?php 
		$editors	=	$this->db->get('editor' )->result_array();
		...
		?>
				...
				<td style="text-align: center;"><?php if ($row['status'] == 1):?>
           		...
           		<?php endif;?></td>
			    <td style="text-align: center;" class="text-nowrap"><a href="<?php echo base_url();?>admin/editor_profile/<?php echo $row['editor_id'];?>" data-toggle="tooltip" data-original-title="Profile"> <i class="fa fa-user text-inverse m-r-10"></i> </a> </td>

           <td style="text-align: center;" class="text-nowrap"><a href="#" data-toggle="tooltip" onclick="confirm_modal('<?php echo base_url();?>admin/editors/delete/<?php echo $row['editor_id'];?>' , '<?php echo base_url();?>admin/reload_admin_list');" data-original-title="Delete"> <i class="fas fa-trash text-danger m-r-10"></i> </a></td>
                </tr>
                <?php endforeach;?>
              </tbody>
            </table>
	...
	<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                	<?php echo form_open(base_url() . 'admin/editors/create/' , array('class' => 'form-horizontal form-groups-bordered validate ajax-submit', 'enctype' => 'multipart/form-data'));?>
