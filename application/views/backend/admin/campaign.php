...
<div class="tab-content">
  ...
  <div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                  <?php echo form_open(base_url() . 'admin/campaign/create/' , array('class' => 'form-horizontal form-groups-bordered validate ajax-submit', 'enctype' => 'multipart/form-data'));?>
        ...
        <div class="padded">
             ...
             <div class="form-group">
              ...
              <div class="form-group">
                  <label class="col-sm-2 control-label">Attachement</label>
                  <div class="col-sm-10">
                  <div class="input-group">
                    <div class="input-group-addon"><i class="fa fa-paperclip"></i></div>
                    <input type="file" class="form-control" accept="application/pdf" name="attachement">
                  </div>
                  </div>
                </div>
