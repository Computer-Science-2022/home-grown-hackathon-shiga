...
<div class="row bg-title">
    ...
    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
        <ol class="breadcrumb">
  		    <li><a href="<?php echo base_url(); ?>admins/admin_dashboard"><?php echo get_phrase('Dashboard');?></a></li>
            <li><a class="active">Admins</a></li>
        </ol>
    </div>
</div>
...
<div class="tab-content">
		...
		?>
				...
				<td style="text-align: center;"><?php if ($row['status'] == 1):?>
           		...
           		<?php endif;?></td>
			    <td style="text-align: center;" class="text-nowrap"><a href="<?php echo base_url();?>admin/admin_profile/<?php echo $row['admin_id'];?>" data-toggle="tooltip" data-original-title="Profile"> <i class="fa fa-user text-inverse m-r-10"></i> </a> </td>

           <td style="text-align: center;" class="text-nowrap"> <?php if ($is_owner == 1 && $row['admin_id'] != $this->session->userdata('login_user_id')):?><a href="#" data-toggle="tooltip" onclick="confirm_modal('<?php echo base_url();?>admin/admins/delete/<?php echo $row['admin_id'];?>' , '<?php echo base_url();?>admin/reload_admin_list');" data-original-title="Delete"> <i class="fa fa-trash text-danger m-r-10"></i> </a> <?php endif;?></td>
                </tr>
                <?php endforeach;?>
              </tbody>
            </table>
	...
	<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                	<?php echo form_open(base_url() . 'admin/admins/create/' , array('class' => 'form-horizontal form-groups-bordered validate ajax-submit', 'enctype' => 'multipart/form-data'));?>
