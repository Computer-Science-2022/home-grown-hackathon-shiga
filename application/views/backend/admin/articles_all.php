...
<div class="row">
    ...
    $this->db->order_by('id', 'DESC');
		$posts	=	$this->db->get('articles' )->result_array();
		...
		?>
                                <tr>
                                    ...
                                    <td style="text-align: center;" class="text-nowrap"><a
                                            href="<?php echo base_url();?>admin/articles/edit/<?php echo $row['id'];?>"
                                            data-toggle="tooltip" data-original-title="Edit"> <i
                                                class="fa fa-edit text-danger m-r-10"></i> </a> </td>

                                    <td style="text-align: center;" class="text-nowrap"><a href="#"
                                            data-toggle="tooltip"
                                            onclick="confirm_modal('<?php echo base_url();?>admin/articles/delete/<?php echo $row['id'];?>' , '<?php echo base_url();?>admin/reload_admin_list');"
                                            data-original-title="Delete"> <i class="fa fa-trash text-danger m-r-10"></i>
                                        </a></td>
                                </tr>
                                <?php endforeach;?>
                            </tbody>
                    ...
                    <div class="col-md-12">
                        <div class="white-box">
                            ...
                            <div class="padded">
                                ...
                                <div class="form-group">
                                    <label for="field-1"
                                        class="col-sm-4 control-label"><?php echo get_phrase('Type-Account');?></label>
                                    <div class="col-sm-5">
                                        ...
                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                            ...
                                            <div>
                                                <span class="btn btn-red btn-file">
                                                    <span
                                                        class="fileinput-new"><?php echo get_phrase('Select');?></span>
                                                    <span
                                                        class="fileinput-exists"><?php echo get_phrase('Change');?></span>
