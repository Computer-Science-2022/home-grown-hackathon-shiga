...
<div class="tab-content">
    ...
    ?>
                <tr>
                  <td><?php echo $i;?></td>
              <td style="text-align: left;"><?php if(!$row['reply']){?><a href="<?php echo base_url().'Admin/reply_inquiry/'.$row['id'];?>" data-toggle="tooltip" data-original-title="Reply this inquiry"><?php echo $row['message'];?></a><?php }else{echo $row['message'];}?></td>
