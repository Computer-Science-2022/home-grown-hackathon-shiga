<div class="row">
    <div class="white-box">
    <span class="page-title">Add Admin</span><hr>
        <form class="form-horizontal form-material" method="POST" action="<?php echo base_url();?>admin/admins/create" enctype="multipart/form-data">
