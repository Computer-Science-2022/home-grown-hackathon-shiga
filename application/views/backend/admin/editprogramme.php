<?php
  $product = $this->db->get_where('programmes', array('id' => $project_id))->result_array();
...
<div style="margin-left: 2%; margin-right: 2%;" style="height: 80vh; overflow: scroll;">
    <div class="row" style="height: 80vh; overflow: scroll;">
        <span class="page-title">Edit Programme</span><hr>
        <form class="form-horizontal form-material" method="POST" action="<?php echo base_url();?>admin/programme/update" enctype="multipart/form-data">
        <div class="white-box">
            ...
            <center><button class="btn btn-primary aog-btn">Proceed to Update Programme</button></center>
        </form>
