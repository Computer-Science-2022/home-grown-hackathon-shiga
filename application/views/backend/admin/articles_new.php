...
<body>
    ...
    <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title">Add New Articles</h4>
        </div>
    ...
    <div class="tab-content">
        <div class="tab-pane box active" id="list">
            <form method="POST" action="<?php echo base_url();?>Admin/articles/create/" enctype="multipart/form-data">
                <div class="white-box">
                    <h3 class="box-title" style="color: black;">English Articles</h3>
                ...
                <div class="white-box">
                    <h3 class="box-title" style="color: black;">French Articles</h3>
                    <!-- <textarea name="vision" class="textarea_editor form-control" id="text" required=""></textarea>  -->
                ...
                <div class="white-box">
                    ...
                    <h3 class="box-title" style="color: black;">Kinyarwanda Articles</h3>
                    <textarea name="post_kin"></textarea>
                </div>
                <div class="white-box">
                    <h3 class="box-title" style="color: black;">Attachment</h3>
                    <!-- <textarea name="vision" class="textarea_editor form-control" id="text" required=""></textarea>  -->
