...
<div class="row">
    ...
    $this->db->order_by('id', 'DESC');
		$posts	=	$this->db->get('news' )->result_array();
		...
		?>
                                <tr>
                                    ...
                                    <td style="text-align: center;" class="text-nowrap"><a
                                            href="<?php echo base_url();?>admin/news/edit/<?php echo $row['id'];?>"
                                            data-toggle="tooltip" data-original-title="Edit"> <i
                                                class="fa fa-edit text-danger m-r-10"></i> </a> </td>

                                    <td style="text-align: center;" class="text-nowrap"><a href="#"
                                            data-toggle="tooltip"
                                            onclick="confirm_modal('<?php echo base_url();?>admin/news/delete/<?php echo $row['id'];?>' , '<?php echo base_url();?>admin/reload_admin_list');"
