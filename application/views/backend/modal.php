    ...
    <div class="modal fade" id="modal-4">
        ...
        <script type="text/javascript">
    function sendSMS_modal(sendsms_url)
    {
        jQuery('#modal-9').modal('show', {backdrop: 'static'});
        document.getElementById('sendsms_url').setAttribute('href' , sendsms_url);
    }
    </script>
    ...
    <div class="modal fade" id="modal-9">
        <div class="modal-dialog">
            <div class="modal-content" style="margin-top:100px;">            
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title" style="text-align:center;"><?php echo get_phrase('Are you sure you want to send sms '); ?></h4>
                </div>
                <div class="modal-footer" style="margin:0px; border-top:0px; text-align:center;">
                    <a href="#" class="btn btn-danger" id="sendsms_url"><?php echo get_phrase('Send'); ?></a>
                    <button type="button" class="btn btn-info" data-dismiss="modal"><?php echo get_phrase('Cancel'); ?></button>
                </div>
            </div>
        </div>
