...
<head><?php
  ...
  ?>
	...
	<meta name="description" content="Welcome to <?php echo $system_title;?>" />
  ...
  <link rel="icon" type="ico" sizes="16x16" href="style/images/logo.png">
...
<section id="wrapper" class="login-register">
	...
	<form class="form-horizontal form-material" method="post" role="form" id="form_login" action="<?php echo base_url();?>login/ajax_login">
        ...
        <div class="form-group text-center m-t-20">
          <div class="col-xs-12">
            <button class="btn btn-info btn-lg btn-block text-uppercase waves-effect waves-light" type="submit" style="background-color: #008000; border: solid 0px;"><?php echo get_phrase('Login'); ?></button>
          </div>
        </div>
</form>
</div>
