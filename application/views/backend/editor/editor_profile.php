...
<div class="main_data">
    <?php
$profile_info = $this->db->get_where('editor' , array('editor_id' => $editor_id))->result_array();
foreach($profile_info as $row):?>
          ...
          <div class="user-bg"> <img src="style/images/large/img.jpg" alt="user" style="100%">
              <div class="overlay-box">
                <div class="user-content"><a href="javascript:void(0)"><img alt="img" class="thumb-lg img-circle" src="<?php echo base_url().'uploads/editor_image/'.$editor_id.'.jpg';?>"></a>
            ...
            <ul class="basic-list">
              ...
              <li><?php echo get_phrase('Account-Status');?><span class="pull-right label-warning label"><?php if($row['status'] == 1) echo get_phrase('Active'); if($row['status'] == 0) echo get_phrase('Inactive')?></span></li>
            </ul>
          </div>
        </div>
              <div class="col-md-7">
            ...
            <div class="panel-body">
               <?php $edit_data = $this->db->get_where('editor' , array('editor_id' => $editor_id))->result_array();
                      foreach ($edit_data as $row2):
                ?>
                    <?php echo form_open(base_url() . 'editor/editors/do_update/'.$row2['editor_id'], array('class' => 'form-horizontal form-groups-bordered validate ajax-submit', 'enctype' => 'multipart/form-data'));?>
                        ...
                        <label class="col-sm-3 control-label"><?php echo get_phrase('Account-Status');?></label>
                         <div class="col-sm-8">
                          <select class="form-control" name="status">
                                 ...
                                 <option value="0" <?php if($row2['status'] == 0) echo 'selected'?>><?php echo get_phrase('Inactive');?></option>
                         </select>
                        </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="field-2" class="col-sm-3 control-label">Facebook URL</label>

                            <div class="col-sm-8">
                                    <input type="text" class="form-control" name="facebook_url" value="<?php echo $row2['facebook_url'];?>"  >
                            </div> 
                        </div>
                        <div class="form-group">
                            <label for="field-2" class="col-sm-3 control-label">Twitter URL</label>

                            <div class="col-sm-8">
                                    <input type="text" class="form-control" name="twitter_url" value="<?php echo $row2['twitter_url'];?>"  >
                            </div> 
                        </div>
                        <div class="form-group">
                            <label for="field-2" class="col-sm-3 control-label">Instagram URL</label>

                            <div class="col-sm-8">
                                    <input type="text" class="form-control" name="instagram_url" value="<?php echo $row2['instagram_url'];?>"  >
                            </div> 
                        </div>
                        <div class="form-group">
                            <label for="field-2" class="col-sm-3 control-label">LinkedIn URL</label>

                            <div class="col-sm-8">
                                    <input type="text" class="form-control" name="linkedin_url" value="<?php echo $row2['linkedin_url'];?>"  >
                            </div> 
                        </div>
              ...
              <div class="fileinput fileinput-new" data-provides="fileinput">
                    <div class="fileinput-new thumbnail" style="width: 100px; height: 100px;" data-trigger="fileinput">
                      <img src="<?php echo $this->Crud_model->get_image_url('editor' , $row2['editor_id']);?>" alt="...">
                    </div>
...
<div class="row">
    <div class="col-md-12">
        <div class="panel">
            ...
            <div class="panel-body">
                    <?php 
                   $edit_datas = $this->db->get_where('editor' , array('editor_id' => $editor_id))->result_array();
                    foreach($edit_datas as $row3):
                        ?>
                         <?php echo form_open(base_url() . 'editor/editors/change_password/'.$row3['editor_id'], array('class' => 'form-horizontal form-groups-bordered validate ajax-submit', 'enctype' => 'multipart/form-data'));?>
