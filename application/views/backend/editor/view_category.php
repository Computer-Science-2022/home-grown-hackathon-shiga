...
<div class="tab-content tab-pane box">
      ...
      <div class="white-box col-md-12">
        ...
        <div class="col-md-9">
          <?php echo form_open(base_url() . 'editor/categories/update_profile/'.$row['id'], array('class' => 'form-horizontal form-groups-bordered validate ajax-submit', 'enctype' => 'multipart/form-data'));?>
          ...
          <div class="form-group">
            <div class="col-sm-offset-3 col-sm-3">
             ...
             <?php echo form_close();?>
                  ...
                  <?php echo form_open(base_url() . 'editor/categories/update/'.$row['id'], array('class' => 'form-horizontal form-groups-bordered validate ajax-submit', 'enctype' => 'multipart/form-data'));?>
