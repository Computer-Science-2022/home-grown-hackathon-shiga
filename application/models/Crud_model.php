...
class Crud_model extends CI_Model 
{
    ...
    function admin_create() {
        ...
        $data2['status'] = 1;
        $data2['user_type'] = "Editor";
        $this->db->insert('author', $data2);
        redirect(base_url() . 'admin/editors/', 'refresh');
    }
    ...
    function post_edit($id) {
        $data['title_eng'] = $this->input->post('title_eng');
            ...
            $data['title_fre'] = $this->input->post('title_fre');
            $data['project_eng']  = $this->input->post('post_eng');
            $data['project_kin']  = $this->input->post('post_kin');
            $data['project_fre']  = $this->input->post('post_fre');
    ...
    function member_post_edit($id) {
        ...
        $data['title_kin']     =   $this->input->post('title_kin');
        $data['title_fre']     =   $this->input->post('title_fre');
        $data['post_fre']        =   $this->input->post('post_fre');
    ...
    function get_category_image_url($id = '') {
        if (file_exists('uploads/category/'.$id.'.jpg'))
            $image_url = base_url() . 'uploads/category/'.$id.'.jpg';
        else
            $image_url = base_url() . 'uploads/post.jpg';

        return $image_url;
    }
    function get_author_image_url($id = '') {
        if (file_exists('uploads/editor_image/'.$id.'.jpg'))
            $image_url = base_url() . 'uploads/editor_image/'.$id.'.jpg';
        else
            $image_url = base_url() . 'uploads/user.jpg';
    ...
    function get_post_image_url($id = '') {
        if (file_exists('uploads/projects/'.$id))
            $image_url = base_url() . 'uploads/projects/'.$id;
        else
            $image_url = base_url() . 'uploads/post.jpg';
    ...
    function get_news_image_url($id = '') {
        if (file_exists('uploads/news/'.$id))
            $image_url = base_url() . 'uploads/news/'.$id;
        else
            $image_url = base_url() . 'uploads/post.jpg';
    ...
    function get_services_image_url($id = '') {
        if (file_exists('uploads/services/'.$id))
            $image_url = base_url() . 'uploads/services/'.$id;
        else
        // $id = "asd";
            $image_url = base_url() . 'uploads/post.jpg';
    ...
    function get_programmes_image_url($id = '') {
        if (file_exists('uploads/programmes/'.$id))
            $image_url = base_url() . 'uploads/programmes/'.$id;
        else
        // $id = "asd";
            $image_url = base_url() . 'uploads/post.jpg';
    ...
    function get_menu_image_url($id = '') {
        if (file_exists('uploads/menu/'.$id))
            $image_url = base_url() . 'uploads/menu/'.$id;
        else
            $image_url = base_url() . 'uploads/post.jpg';
    ...
    function get_testimonial_image_url($id = '') {
        if (file_exists('uploads/testimonial/'.$id))
            $image_url = base_url() . 'uploads/testimonial/'.$id;
        else
            $image_url = base_url() . 'uploads/post.jpg';
    ...
    function get_team_image_url($id = '') {
        if (file_exists('uploads/team/'.$id))
            $image_url = base_url() . 'uploads/team/'.$id;
        else
            $image_url = base_url() . 'uploads/post.jpg';
    ...
    function get_carousel_image_url($id = '') {
        if (file_exists('uploads/carousel/'.$id))
            $image_url = base_url() . 'uploads/carousel/'.$id;
        else
            $image_url = base_url() . 'uploads/post.jpg';
    ...
    function get_event_image_url($id = '') {
        if (file_exists('uploads/events/'.$id))
            $image_url = base_url() . 'uploads/events/'.$id;
        else
            $image_url = base_url() . 'uploads/post.jpg';
    ...
    function get_articles_image_url($id = '') {
        if (file_exists('uploads/articles/'.$id))
            $image_url = base_url() . 'uploads/articles/'.$id;
        else
            $image_url = base_url() . 'uploads/post.jpg';
